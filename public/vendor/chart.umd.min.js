...
!(function (t, e) {
		...
		acquireContext(t, e) {
			...
			return i && i.canvas === t
				? ((function (t, e) {
						...
						if (
							((t[ds] = { initial: { height: s, width: n, style: { display: i.display, height: i.height, width: i.width } } }),
		...
		update(t, e, i) {
			...
			(this.beforeUpdate(),
				...
				this._dataLimitsCached ||
					(this.beforeDataLimits(), this.determineDataLimits(), this.afterDataLimits(), (this._range = Di(this, n, s)), (this._dataLimitsCached = !0)),
	...
	class Tn {
		...
		constructor(t, e) {
			...
			((this.id = i()),
				...
				(Cn[this.id] = this),
				r && l
					? (bt.listen(this, "complete", Sn), bt.listen(this, "progress", Pn), this._initialize(), this.attached && this.update())
		...
		buildOrUpdateControllers() {
			...
			for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
				...
				if (
					...
					(Object.assign(e, { dataElementType: nn.getElement(a), datasetElementType: s && nn.getElement(s) }),
		...
		render() {
			!1 !== this.notifyPlugins("beforeRender", { cancelable: !0 }) &&
				(bt.has(this) ? this.attached && !bt.running(this) && bt.start(this) : (this.draw(), Sn({ chart: this })));
		}
		draw() {
			let t;
		...
		_drawDataset(t) {
			...
			!1 !== this.notifyPlugins("beforeDatasetDraw", i) &&
				(s && Ie(e, s), t.controller.draw(), s && ze(e), (i.cancelable = !1), this.notifyPlugins("afterDatasetDraw", i));
		}
		isPointInArea(t) {
	...
	function Wn(t, e, i, s) {
		...
		("middle" === n &&
			i &&
			((t.enableBorderRadius = !0), (i._top || 0) === s ? (n = h) : (i._bottom || 0) === s ? (n = c) : ((o[Nn(c, a, r, l)] = !0), (n = h))),
			(o[Nn(n, a, r, l)] = !0),
			(t.borderSkipped = o));
	}
	function Nn(t, e, i, s) {
				...
				legend: {
					labels: {
						generateLabels(t) {
							const e = t.data,
								{
									labels: { pointStyle: i, textAlign: s, color: n, useBorderRadius: o, borderRadius: a },
								} = t.legend.options;
	...
	var Un = Object.freeze({
		...
		BarController: class extends js {
			...
			_getStacks(t, e) {
				...
				for (const i of n)
					if ((void 0 === e || !h(i)) && ((!1 === o || -1 === a.indexOf(i.stack) || (void 0 === o && void 0 === i.stack)) && a.push(i.stack), i.index === t))
						break;
	...
	function Gn(t, e, i, s, n) {
		...
		(t.setLineDash(d || []),
			(t.lineDashOffset = u),
			g ? ((t.lineWidth = 2 * h), (t.lineJoin = c || "round")) : ((t.lineWidth = h), (t.lineJoin = c || "bevel")));
		let p = e.endAngle;
		if (o) {
			Kn(t, e, i, s, p, n);
	...
	var go = Object.freeze({
		...
		BarElement: class extends $s {
			...
			draw(t) {
				...
				var r;
				(t.save(),
					(o.w === n.w && o.h === n.h) || (t.beginPath(), a(t, fo(o, e, n)), t.clip(), a(t, fo(n, -e, o)), (t.fillStyle = i), t.fill("evenodd")),
					t.beginPath(),
					a(t, fo(n, e)),
					(t.fillStyle = s),
					t.fill(),
	...
	function po(t, e, i, s) {
		const n = t.indexOf(e);
		if (-1 === n)
			return ((t, e, i, s) => ("string" == typeof e ? ((i = t.push(e) - 1), s.unshift({ index: i, label: e })) : isNaN(e) && (i = null), i))(t, e, i, s);
			...
			return (function (t) {
				const { scale: e = {}, fill: i } = t,
					s = (function (t, e) {
						let i = null;
						return (
							"start" === t ? (i = e.bottom) : "end" === t ? (i = e.top) : o(t) ? (i = e.getPixelForValue(t.value)) : e.getBasePixel && (i = e.getBasePixel()),
							i
						);
					})(i, e);
				if (a(s)) {
			...
			(function (t, e) {
				...
				o !== n &&
					("x" === h
						...
						: "y" === h &&
							(ga(t, s, a.left), pa(t, { line: i, target: s, color: o, scale: r, property: h, clip: l }), t.restore(), t.save(), ga(t, s, a.right), (c = n)));
			...
			for (a = 0; a < s; ++a)
				((o = t.getDatasetMeta(a)),
					...
					r &&
						r.options &&
						r instanceof oo &&
						(l = { visible: t.isDatasetVisible(a), index: a, fill: ra(r, a, s), chart: t, axis: o.controller.options.indexAxis, scale: o.vScale, line: r }),
					(o.$filler = l),
					n.push(l));
			...
			(this.legendItems.forEach((y, v) => {
				...
				(r.setWidth(this.width),
					x
						...
						: v > 0 &&
							P + _ > this.bottom &&
							((S = f.x = S + e[f.line].width + c), f.line++, (P = f.y = ft(n, this.top + b + c, this.bottom - e[f.line].height))));
				if (
					((function (t, e, i) {
	...
	class Wa extends $s {
		...
		getContext() {
			return (
				this.$context ||
				(this.$context = ((t = this.chart.getContext()), (e = this), (i = this._tooltipItems), Ci(t, { tooltip: e, tooltipItems: i, type: "tooltip" })))
			);
			var t, e, i;
		}
		getTitle(t, e) {
